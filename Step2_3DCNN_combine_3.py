...
outPred_cropped=os.path.join(r"./ConvNet_3DCNN\training\Depth_ConvNet__2014-05-28_01.59.00_150/")  
outPred_cropped_2=os.path.join(r"./ConvNet_3DCNN\training\Depth_ConvNet__2014-06-25_18.56.59_162/")  
outPred_depth =r'.\ConvNet_3DCNN\training\Depth_ConvNet__2014-06-25_18.21.33_250/'
...
predPath='./ConvNet_3DCNN/training/combined_3_depth_pred/'
...
for file_count, file in enumerate(samples_cropped):
    if  True:#file_count==26:
        if file ==  samples_depth[file_count] and outPred_cropped_2[file_count]:
            ...
            if True:
                ...
                from pylab import *
                if True:
                    save_dir=r'.\ConvNet_3DCNN\training\Depth_path_combined_3'
...
# The score for this prediction is  0.701750820513!!!!!!!!!! Combine two depth!!!!!
