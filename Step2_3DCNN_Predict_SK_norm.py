...
op.options['load_file'].value=r'.\ConvNet_3DCNN\tmp\ConvNet__2014-06-25_18.21.33'
...
for file_count, file in enumerate(samples):        
    if  not file_count<650:
        ...
        if True:
            ...
            from pylab import *
            if True:
                save_dir=r'.\ConvNet_3DCNN\training\Depth_path'
        ...
        save_dir=r'.\ConvNet_3DCNN\training\Depth'
        save_path= os.path.join(save_dir,file)
