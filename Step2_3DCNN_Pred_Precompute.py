...
outPred='./ConvNet_3DCNN/training/Valid_3DCNN_' + CNN_NAME
...
cnn_path=os.path.join(".\ConvNet_3DCNN\Depth_Precompute\\")  
...
for file_count, file in enumerate(samples):        
    if  not file_count<650:
        if file ==  samples_cnn[file_count-650]:
            time_tic = time.time()  
            ...
            if True:
                ...
                from pylab import *
                if True:
                    save_dir=r'.\ConvNet_3DCNN\training\Depth_path_'+ CNN_NAME
            ...
            save_dir=r'.\ConvNet_3DCNN\training\Depth_'+ CNN_NAME
            if not os.path.exists(save_dir):
                os.makedirs(save_dir)            
            save_path= os.path.join(save_dir,file)
...
#Cropped: \ConvNet_3DCNN\tmp\ConvNet__2014-05-28_01.59.00'
#The score for this prediction is 0.514078928486

#The score for this prediction is 0.686585827374 ConvNet__2014-06-25_18.21.33_100
#The score for this prediction is 0.692423435630 ConvNet__2014-06-25_18.21.33_250
#The score for this prediction is 0.729009426871 ConvNet__2014-05-28_01.59.00_150!!! --old!!!
#The score for this prediction is 0.696395444797 ConvNet__2014-06-25_18.56.59_162